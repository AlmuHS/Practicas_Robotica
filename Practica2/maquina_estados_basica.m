%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% controla el movimiento del robot mediante una mï¿½qunia de estado.
% Utiliza los script: 
...
% Declaraciï¿½n de sensores
OpenSwitch(SENSOR_2); % definiciï¿½n del sensor de contacto detceta coliiï¿½n
OpenSwitch(SENSOR_1); % definiciï¿½n del sensor de contacto para start
OpenUltrasonic(SENSOR_4); %definiciï¿½n del sonar

% Declaraciï¿½n de los motores
        ...
        switch estado
            ...
            case 1 %andando hacia delante
                if (GetUltrasonic(SENSOR_4)<stop_distance) %si la distancia es menor que 35 para
                    estado=2; %transiciï¿½n de estado de paro
            ...
            case 2 %parando
                if (vel==0)
                    if distancia(i)>stop_distance
                        estado=1; %la transiciï¿½n a estado marcha hacia delante
           ...
           case 5 %marcha atrï¿½s
                if (t(i)-t(transicion)>t_marcha_atras)                  
                    estado=2; %transiciï¿½n a estado girando cabeza
                    transicion=i; %indice que marca el inicio del estado 2                 
                end
